...
export const validationSchema = Joi.object({
  ...
  QUEUE_MONITOR_DLQ_ALERT_THRESHOLD: Joi.number().default(1),
  QUEUE_MONITOR_DLQ_ALERT_COOLDOWN_MS: Joi.number().default(1800000),
  QUEUE_MONITOR_NO_CONSUMER_ALERT_THRESHOLD: Joi.number().default(10),
  QUEUE_MONITOR_NO_CONSUMER_ALERT_COOLDOWN_MS: Joi.number().default(600000),
