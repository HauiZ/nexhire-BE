...
export class CreateCompaniesTable1783786890301 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`CREATE UNIQUE INDEX "uq_company_tax_code" ON "companies" ("tax_code")`);
    await queryRunner.query(`CREATE UNIQUE INDEX "uq_company_owner_id" ON "companies" ("owner_id")`);
  }

  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`DROP INDEX "public"."uq_company_owner_id"`);
