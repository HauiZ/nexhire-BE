...
Thu muc nay gom cac flow BE da chot de FE gan API dung ngu nghia.
...
- Docs trong thu muc nay la hand-off theo flow FE.
- API contract day du van nam trong `api-docs/`.
- `plans/` la local-only va khong push remote.
